...
RSpec.describe AsyncHttpPool::RequestHelper do
  after do
  ...
  describe ".register_handler" do
    ...
    it "registers a callable object" do
      request_context = instance_double(AsyncHttpPool::RequestContext)
  ...
  describe ".execute" do
    it "raises when no handler is registered" do
      expect {
        described_class.execute(instance_double(AsyncHttpPool::RequestContext))
      }.to raise_error(
        RuntimeError,
  ...
  describe "class-level request helpers" do
    it "builds a request from the class template and executes the registered handler" do
      ...
      expect(captured_context).to be_a(AsyncHttpPool::RequestContext)
      ...
      expect(request).to be_a(AsyncHttpPool::Request)
