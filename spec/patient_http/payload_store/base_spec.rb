...
require "spec_helper"
require "tmpdir"
RSpec.describe PatientHttp::PayloadStore::Base do
  ...
  describe ".create" do
    it "creates a store instance from a registered adapter" do
      ...
      expect(store).to be_a(PatientHttp::PayloadStore::FileStore)
    end
  ...
  describe "#generate_key" do
    let(:store) { PatientHttp::PayloadStore::FileStore.new }
