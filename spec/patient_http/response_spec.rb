...
RSpec.describe PatientHttp::Response do
  describe "#initialize" do
    it "initializes with keyword arguments" do
      ...
      expect(response.headers).to be_a(PatientHttp::HttpHeaders)
    ...
    it "accepts callback_args" do
      ...
      expect(response.callback_args).to be_a(PatientHttp::CallbackArgs)
